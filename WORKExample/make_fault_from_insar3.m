function [slip_model,RMS_misfit,model_roughness,insar_model1,insar_model2] = make_fault_from_insar3(slip_model_vs,slip_model_ds,iter_step,varargin)
...
%     end
    ...
    [G1_raw,G1,bd1_raw,bd1] = build_green_function(slip_model,['/Users/xiaoyuzou/Library/CloudStorage/OneDrive-UCSanDiego/Research/TurkeyEQ/WORKExample/ASC100/LOS2/los_samp',num2str(iint),'.mat'],'insar','noramp',model_type);
    [G2_raw,G2,bd2_raw,bd2] = build_green_function(slip_model,['/Users/xiaoyuzou/Library/CloudStorage/OneDrive-UCSanDiego/Research/TurkeyEQ/WORKExample/DES5/LOS2/los_samp',num2str(iint),'.mat'],'insar','noramp',model_type);
