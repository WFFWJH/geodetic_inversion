...
slip_model_vs = load_fault_one_plane(fault_file,'dip_change_id',dip_change_id,'dip',dip_angle,'lonc',lonc,'latc',latc,'ref_lon',ref_lon,'len_top',1.2e3);
...
resamp_insar_data(slip_model,data_list,Nmin, Nmax, iter_step2, 'fault', fault_file, 'dec',2, 'lonc', lonc, 'latc', latc, 'ref_lon', ref_lon);
