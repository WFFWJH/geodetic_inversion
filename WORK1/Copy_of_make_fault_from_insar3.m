...
[G1_raw,G1,bd1_raw,bd1] = build_green_function(slip_model,['./myama/D33/LOS/los_samp',num2str(iint),'.mat'],'insar','noramp',model_type);
[G2_raw,G2,bd2_raw,bd2] = build_green_function(slip_model,['./myama/D33/RNG/los_samp',num2str(iint),'.mat'],'insar','noramp',model_type);
[G3_raw,G3,bd3_raw,bd3] = build_green_function(slip_model,['./myama/D33/AZI/los_samp',num2str(iint),'.mat'],'AZO','noramp',model_type);
...
plot_insar_model_resampled(['./myama/D33/LOS/los_samp',num2str(iint),'.mat'],insar_model1,'iter_step',iint,'fault',fault_file,'model_type',model_type,'misfit_range',30,'defo_max',120,'ref_lon',ref_lon,'lonc',lon_eq,'latc',lat_eq);
plot_insar_model_resampled(['./myama/D33/RNG/los_samp',num2str(iint),'.mat'],insar_model2,'iter_step',iint,'fault',fault_file,'model_type',model_type,'misfit_range',30,'defo_max',120,'ref_lon',ref_lon,'lonc',lon_eq,'latc',lat_eq);
plot_insar_model_resampled(['./myama/D33/AZI/los_samp',num2str(iint),'.mat'],insar_model3,'iter_step',iint,'fault',fault_file,'model_type',model_type,'misfit_range',30,'defo_max',120,'ref_lon',ref_lon,'lonc',lon_eq,'latc',lat_eq);
