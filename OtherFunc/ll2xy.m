...
r_fn(1)=0;     % Northern Hemisphere Offset
r_fn(2)=1e7;  % Southern Hemisphere Offset

r_ep2 = r_e2/(1.d0 - r_e2);    % Second eccentricity squared
r_e4 = r_e2^2;    % Second eccentricity quadratic
r_e6 = r_e2^3;    % Second eccentricity to the sixth power
...
r_lon0=lon_c*r_dtor;    % Longitude (radians) of the projected central meridian
r_n = r_a./sqrt(1.d0 - r_e2*sin(yi).^2);    % curvature radius
r_t = tan(yi).^2;
r_t2 = r_t.^2;
r_c = r_ep2*cos(yi).^2;
